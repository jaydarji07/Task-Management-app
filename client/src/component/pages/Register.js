...
const Register = () => {
  ...
  return (
    <div className='signup'>
      <div className='shadow-lg signup-content'>
        <div className="row mx-0">
          <div className="col-lg-6">
            <div className='p-5'>
              <p className='signup-text'>Sign in Your Account</p>
          ...
          <div className="col-lg-6 sign-img">
            <figure>
            <img src="https://swiftrut.com/wp-content/uploads/2024/06/Light.png" alt="" width="350" height="150"></img>
